...
- Make the preview status explicit: experimental, bring your own Groq API key, no hosted backend, no warranty.
...
- Add repository topics such as `macos`, `swift`, `menubar`, `speech-to-text`, and `groq`.
