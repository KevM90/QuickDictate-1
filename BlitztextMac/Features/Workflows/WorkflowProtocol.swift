...
struct AppSettings: Codable {
    ...
    var groqTranscriptionModel: String = GroqTranscriptionModel.defaultModel.rawValue
    var groqChatModel: String = GroqChatModel.defaultModel.rawValue
    ...
    init(
        ...
        groqTranscriptionModel: String = GroqTranscriptionModel.defaultModel.rawValue,
        groqChatModel: String = GroqChatModel.defaultModel.rawValue
    ) {
    ...
    init(from decoder: Decoder) throws {
        ...
        groqTranscriptionModel = try container.decodeIfPresent(
            String.self,
            forKey: .groqTranscriptionModel
        ) ?? GroqTranscriptionModel.defaultModel.rawValue
        groqChatModel = try container.decodeIfPresent(
            String.self,
            forKey: .groqChatModel
        ) ?? GroqChatModel.defaultModel.rawValue
    }
}
