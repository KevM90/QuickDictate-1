...
final class DampfAblassenWorkflow: Workflow {
    ...
    private let groqTranscriptionModel: String
    private let groqChatModel: String
    ...
    private func processRecording() {
        ...
        processingTask = Task {
            ...
            do {
                // Phase 1: Groq transcription
                let rawText = try await GroqTranscriptionService.transcribe(
                    audioURL: url,
                ...
                // Phase 2: Groq dampf ablassen
                phase = .running("Wird umformuliert ...")

                let answer = try await GroqLLMService.dampfAblassen(
                    text: cleanedRawText,
